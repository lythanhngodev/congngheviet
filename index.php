...
<div id="an-hien" class="black-mask animated fadeInDown" style="display:none;">
    <div class="dropdown-menu-right" style="display: block;">
        <form role="search" method="get" class="form-inline" action="http://localhost:8080/congngheviet">
...
<div id="menu">
<ul>
	<li class="logo"><img src="mstile-144x144.png" alt="" title="CÔNG NGHỆ VIỆT" onClick="home()" /></li>
	<li class="cong-nghe"><a id="me-cn" href="chuyenmuc/1/cong-nghe">Công nghệ</a></li>
    <li class="su-kien"><a id="me-sk" href="chuyenmuc/2/su-kien">Sự kiện</a></li>
    <li class="danh-gia"><a id="me-dg" href="chuyenmuc/3/danh-gia">Đánh giá</a></li>
    <li class="thu-thuat-ung-dung"><a id="me-ttud" href="chuyenmuc/4/ung-dung-thu-thuat">Thủ thuật - Ứng dụng</a></li>
    <li class="khuyen-mai-qc"><a id="me-kmqc" href="chuyenmuc/5/khuyen-mai-quang-cao">Khuyến mãi - Quảng cáo</a></li>
